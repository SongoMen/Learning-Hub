          ...
          {!this.state.lastLessonLoader && (
            <svg
              ...
              <path
                ...
                opacity="0.18"
                transform="translate(-4.89 -12.78)"></path>
              <path
                fill="#1f8efa"
              ...
              <path
                fill="#fff"
                d="M86.23 221h25.91v21.28a7.5 7.5 0 01-7.5 7.5H93.73a7.5 7.5 0 01-7.5-7.5V221z"></path>
              <path
                fill="none"
                stroke="#fff"
                strokeMiterlimit="10"
                strokeWidth="3.3"
                d="M110.39 226.16h7.85a6.25 6.25 0 016.25 6.25V235a6.25 6.25 0 01-6.25 6.25h-7.85 0v-15.09h0z"></path>
              <rect
                width="362.1"
                height="11.11"
                x="45.12"
              ...
              <path
                fill="#1f8efa"
                d="M138.75 260.6H337.14V329.41H138.75z"></path>
              <path
                fill="#1f8efa"
                d="M62.17 260.6H140.10000000000002V329.41H62.17z"></path>
              <path
                fill="url(#d)"
                d="M140.06 260.6H337.15V329.41H140.06z"></path>
              <path
                fill="url(#e)"
                d="M62.17 260.6H140.10000000000002V329.41H62.17z"></path>
              <path
              ...
              <rect
                ...
                fill="#1f8efa"
                rx="6.52"
                transform="rotate(-180 262.75 249.005)"></rect>
              <rect
                width="141.48"
                height="13.04"
                x="194.46"
              ...
              <path
                fill="#fff"
                d="M325.02 141.26H390.97999999999996V149.06H325.02z"></path>
              ...
              <path
                fill="#fff"
                d="M214.9 103.9H257.79V110.83000000000001H214.9z"></path>
              <path
                fill="#fff"
                d="M252.25 68.55H353.65999999999997V75.47999999999999H252.25z"></path>
              <path
                fill="#fff"
              ...
              <path
                fill="#fff"
                d="M177.82 68.55H244.51999999999998V75.47999999999999H177.82z"></path>
              <path fill="#fff" d="M251.35 54.2H352.76V61.13H251.35z"></path>
              <path fill="#fff" d="M176.92 41.18H243.62V48.11H176.92z"></path>
              <path
                fill="#fff"
                d="M176.92 29.3H243.62V36.230000000000004H176.92z"></path>
              <path
                fill="#fff"
                d="M177.82 80.57H220.70999999999998V87.5H177.82z"></path>
            </svg>
          )}
        </div>
